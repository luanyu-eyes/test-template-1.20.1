 ...
 */
@FunctionalInterface
public interface ImplementedInvenory extends SidedInventory {
    /**
     ...
     */
    static ImplementedInvenory of(DefaultedList<ItemStack> items) {
        return () -> items;
    }
     ...
     * @return a new inventory
     */
    static ImplementedInvenory ofSize(int size) {
