...
import com.yi.example.entity.animation.ModAnimations;
...
public class PorcupineModel<T extends PorcupineEntity> extends SinglePartEntityModel<PorcupineEntity> {
