...
public class GemPolishingCategory implements DisplayCategory<BasicDisplay> {
    public static final Identifier TEXTURE =
            new Identifier(ExampleMod.MOD_ID,"textures/gui/gem_polishing_station_gui.png");
    public static final CategoryIdentifier<GemPolishingDisplay> GEM_POLISHING =
            CategoryIdentifier.of(ExampleMod.MOD_ID,"gem_polishing");
    @Override
    ...
    public Renderer getIcon() {
        return EntryStacks.of(ModBlocks.GEN_POLISHING_STATION.asItem().getDefaultStack());
    }
